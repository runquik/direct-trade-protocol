> **Superseded.** This is DTP Specification v0.1 (marketplace-pipeline model), retained verbatim for the v0.1 implementations (`contracts/`, `mcp-server/`, `remote-mcp-server/`, `marketplace/`). The current specification is [`/SPEC.md`](../../SPEC.md) (v0.2, company-record model). Archived 2026-09-03.
