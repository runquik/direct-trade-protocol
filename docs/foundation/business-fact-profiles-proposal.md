...
5. **`party@1`** (done September 23, 2026: `spec/profiles/party/1.md`, contract and fixtures, `party-v1` in the reference host with the personnel-policy rule for person parties, a second implementation in `sdk/tests/interop/party-reader.ts`, registered), then **`order@1`** with the minimal **`forecast@1`** (P14) drafted beside it.
